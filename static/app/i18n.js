...
const translations = {
    'zh-CN': {
        ...
        'config.advanced.outputIdentitySanitize': '输出身份替换',
        'config.advanced.outputIdentitySanitizeNote': '开启后自动将响应中的 Kiro、CodeWhisperer 等替换为 Claude。关闭后输出原始内容。',
    ...
    'en-US': {
        ...
        'config.advanced.outputIdentitySanitize': 'Output Identity Replacement',
        'config.advanced.outputIdentitySanitizeNote': 'When enabled, automatically replaces Kiro, CodeWhisperer, etc. with Claude in responses. When disabled, outputs original content.',
